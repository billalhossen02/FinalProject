...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_staff = models.BooleanField(
            ...
            default=False,
            help_text = ugettext_lazy("Designates wheter the user can log in this site")
    )

    is_active = models.BooleanField(
        ugettext_lazy('active'),
        default=True,
        help_text=ugettext_lazy('Designates wheter this user should be treated as active. Uselect this instead of deleting accounts')
    )
